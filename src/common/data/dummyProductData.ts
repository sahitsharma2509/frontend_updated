...
export const sampleKnowledgeBases: KnowledgeBase[] = [
	{
	  ...
	  inputs: [
		{ id: 1, type: 'url', content: 'https://example.com/ai-article' },
		{ id: 2, type: 'pdf', content: 'intro_to_ml.pdf' },
		{ id: 3, type: 'youtube', content: 'https://youtu.be/example' },
	...
	},
	{
	  ...
	  inputs: [
		{ id: 4, type: 'url', content: 'https://example.com/js-tutorial' },
		{ id: 5, type: 'pdf', content: 'css_basics.pdf' },
		{ id: 6, type: 'youtube', content: 'https://youtu.be/another-example' },
		// More inputs as needed...
	  ],
	},
	// More knowledge bases as needed...
  ];
