...
import data, { CATEGORIES, TTags } from '../presentation/knowledge/helper/dummyKnowledgeData';
...
const Item: FC<IItemProps> = ({ id, image, title, description, tags, color }) => {
	...
	const handleOnClick = useCallback(
		() => router.push(`../${demoPagesMenu.knowledge.subMenu.itemID.path}/${id}`),
		[router, id],
	);
	return (
		<Card
...
const KnowledgeGridPage = () => {
	...
	return (
		<Layout  title={demoPagesMenu.knowledge.subMenu.grid.text}>
