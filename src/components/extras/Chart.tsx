			...
			<ReactApexChart
				options={{
					...
					plotOptions: {
						candlestick: {
							colors: {
								upward: process.env.NEXT_PUBLIC_SUCCESS_COLOR,
								downward: process.env.NEXT_PUBLIC_DANGER_COLOR,
							},
						},
						boxPlot: {
							colors: {
								upper: process.env.NEXT_PUBLIC_SUCCESS_COLOR,
								lower: process.env.NEXT_PUBLIC_DANGER_COLOR,
							},
						},
					},
					...options,
